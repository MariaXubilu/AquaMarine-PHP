...
<div class="sidebar" id="sidebar">
    ...
    <div class="content">
        <h1>Seção - Acessórios</h1>
        <div class="product">
            <img src="imagens/rede.jpg" alt="Rede para peixes">
            <h3>Rede para peixes</h3>
            <p>R$ 18,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
        <div class="product">
            <img src="imagens/racao.jpg" alt="Ração para Goldfish">
            <h3>Ração para Goldfish</h3>
            <p>R$ 32,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
        <div class="product">
            <img src="imagens/limpador.jpg" alt="Limpador Magnético Aquário">
            <h3>Limpador Magnético Aquário</h3>
            <p>R$ 110,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
        <div class="product">
            <img src="imagens/alicate.jpg" alt="Alicate corte de coral">
            <h3>Alicate corte de coral</h3>
            <p>R$ 75,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
        <div class="product">
            <img src="imagens/filtro.jpg" alt="Filtro pequeno">
            <h3>Filtro pequeno</h3>
            <p>R$ 80,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
