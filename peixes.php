...
<div class="sidebar" id="sidebar">
    ...
    <div class="content">
        <h1>Seção - Peixes</h1>
        <div class="product">
            <img src="imagens/betta.jpg" alt="Peixe Betta">
            <h3>Peixe Betta</h3>
            <p>R$ 15,00</p>
        ...
        <div class="product">
            <img src="imagens/neon.jpg" alt="Tetra Neon">
            <h3>Tetra Neon</h3>
            <p>R$ 10,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        ...
        <div class="product">
            <img src="imagens/dourado.jpg" alt="Goldfish">
            <h3>Goldfish</h3>
            <p>R$ 300,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        ...
        <div class="product">
            <img src="imagens/coridora.jpg" alt="Peixe Disco">
            <h3>Coridora</h3>
            <p>R$ 40,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        ...
        <div class="product">
            <img src="imagens/matogrosso.jpg" alt="Peixe Oscar">
            <h3>Mato Grosso</h3>
            <p>R$ 20,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
