...
<div class="sidebar" id="sidebar">
    ...
    <div class="content">
        <h1>Seção - Invertebrados</h1>
        <div class="product">
            <img src="imagens/sand.jpg" alt="Estrela Sand">
            <h3>Estrela Sand</h3>
            <p>R$ 149,00</p>
        ...
        <div class="product">
            <img src="imagens/palhaco.png" alt="Caranguejo Palhaço">
            <h3>Caranguejo Palhaço</h3>
            <p>R$ 40,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
        <div class="product">
            <img src="imagens/fantasma.jpg" alt="Camarão Fantasma">
            <h3>Camarão Fantasma</h3>
            <p>R$ 9,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
        <div class="product">
            <img src="imagens/jade.jpg" alt="Camarão Green Jade">
            <h3>Camarão Green Jade</h3>
            <p>R$ 30,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
        <div class="product">
            <img src="imagens/red.jpg" alt="Caramujo Red Ramshorn">
            <h3>Caramujo Red Ramshorn</h3>
            <p>R$ 8,00</p>
            <input type="number" min="1" value="1">
            <button>Adicionar</button>
        </div>
